...
ifeq ($(IS_HOT10S),true)
BOARD_PREBUILT_VENDORIMAGE := $(HOT10S_PREBUILT)/vendor/hot10s/vendor.img
endif
...
DEVICE_MANIFEST_SKUS += hot10s
DEVICE_MANIFEST_HOT10S_FILES := $(DEVICE_PATH)/configs/vintf/manifest_hot10s.xml
